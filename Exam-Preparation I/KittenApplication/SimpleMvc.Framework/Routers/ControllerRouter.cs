namespace SimpleMvc.Framework.Routers
{
    ...
    public class ControllerRouter : IHandleable
    {
        ...
        public IHttpResponse Handle(IHttpRequest request)
        {
            ...
            if (request.Path == BasePath) // for custom configuration of the path on '/'
            {
        ...
        private IHttpResponse PrepareResponse(Controller controller, MethodInfo method,
            object[] parameters)
        {
            IActionResult actionResult = (IActionResult)method.Invoke(controller, parameters); // !!! //CALLS THE EXACT CONTROLLER!
        ...
        private MethodInfo GetMethod(string requestMethod, Controller controller,
            string actionName)
        {
