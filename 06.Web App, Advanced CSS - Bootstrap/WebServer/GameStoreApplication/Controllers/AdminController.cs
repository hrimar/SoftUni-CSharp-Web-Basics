...
namespace WebServer.GameStoreApplication.Controllers
{
    public class AdminController : BaseController
    {
        ...
        public IHttpResponse List()
        {
            ...
            var result = this.gameService.All()
            ...
            return this.FileViewResponse(@"admin\list-games"); // the file in this folder
        }


        public IHttpResponse EditView( int id) // for  GET
        {
            ...
            if (game == null )
            {
                this.ShowError($"Game #{id} does not exist");
            ...
            this.ViewData["release-date"] = game.ReleaseDate.ToString();
        ...
        //Delete game
        public IHttpResponse DeleteView(int id) // for  GET
        {
            // Accessed by Admins only
            if (!this.Authentication.IsAdmin)
            {
        ...
        public IHttpResponse Delete(int id) // for  POST
        {
            // Delete Game from db
